...
class DatabaseHelper {
  ...
  static final _databaseName = "Perpus.db";
  static final _databaseVersion = 1;

  static final table = 'fav_table';
  
  static final columnId = 'id_books';
  static final columnName = 'name';
  static final columnCat = 'category';
  static final columnPict = 'pictBook';
  static final columnDate = 'DateBook';
  static final columnPub = 'bookPub';
  static final columnLink = 'linkBook';
  static final columnWriter = 'Writer';
  static final columnFav = 'favBooks';
